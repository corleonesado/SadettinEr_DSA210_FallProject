...
This project aims to analyze the short-term impact of news on forex, stock, commodities, and cryptocurrency prices.
Specifically, it investigates how market-moving news affects price changes within 20 seconds after the news is published.
The study will focus on currencies such as EURUSD, XAUUSD, GBPUSD, USDCAD, USDCHF, also NASDAQ, and
major cryptocurrencies such as Bitcoin (BTC), Ethereum (ETH), Ripple (XRP), and Solana (SOL) over the past one year.
...
2-News Data 
The most influential stock news are shared on Yahoo Finance, macro economical news are firstly shared on Forex Factory, and crypto-related news is often first shared through Telegram channels such as Infinity Hedge, Phoenix News, and Tree News.
